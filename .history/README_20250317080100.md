...
API de User é uma API RESTful desenvolvida com NestJS que implementa funcionalidades essenciais de um user, incluindo autenticação JWT, gestão de usuários.
