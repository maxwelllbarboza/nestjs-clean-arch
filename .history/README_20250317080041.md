...
API de User é uma API RESTful desenvolvida com NestJS que implementa funcionalidades essenciais de um user, incluindo autenticação JWT, , usuários e um sistema de carrinho de compras.
